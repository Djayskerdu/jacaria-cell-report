...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyZmtUELfNbZsEFDJthrm9NkSKlRg4wwMaSjT1SHD7Jdq7_glLsB_VAJm5jGuReFCJhcA/exec";
...
// Girls left blank — Anthony doesn't have a co-leader yet. Once one is
  ...
  return (
    <div className="home-wrap">
      <div className="home-hero">
        <span className="eyebrow">Jacaria's Cell Report</span>
    ...
    <div className="shell" data-textsize={textSize}>
      ...
      <header className="topbar">
        <button className="brand" onClick={goHome}>
          ...
          <span className="brand-name">Jacaria's Cell Report</span>
        </button>
